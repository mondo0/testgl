...
from gl.compat import iteritems
from gl.globals import LINUX
from gl.logger import logger
from gl.processes import gl_processes, sort_stats
...
class Plugin(GlancesPlugin):
    ...
    def __init__(self, args=None):
        ...
        # Note: 'gl_processes' is already init in the processes.py script
    ...
    def update(self):
        ...
        if self.input_method == 'local':
            ...
            if gl_processes.is_tree_enabled():
                self.stats = gl_processes.gettree()
            else:
                self.stats = gl_processes.getlist()
    ...
    def msg_curse(self, args=None):
        ...
        process_sort_key = gl_processes.sort_key
        ...
        if gl_processes.is_tree_enabled():
            ret.extend(self.get_process_tree_curses_data(
                ...
                max_node_count=gl_processes.max_processes))
        else:
    ...
    def __sort_stats(self, sortedby=None):
        ...
        return sort_stats(self.stats, sortedby,
                          tree=gl_processes.is_tree_enabled(),
                          reverse=gl_processes.sort_reverse)
